classdef MPCMHE_properties
    ...
    methods 
        ...
        function obj = concat(obj, other)
            ...
            %}
            obj.P1objective = obj.P1objective + other.P1objective;
            obj.P2objective = obj.P2objective + other.P2objective;
        ...
        function opt = setupOptimization(obj)
            classname = class2equilibriumLatentCS(...
                ...
                'outputExpressions',[{obj.P1objective}, obj.outputExpressionsCell],...
