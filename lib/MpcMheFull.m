classdef MpcMheFull
    ...
    properties
        ...
        Tx0
        Tx
        TD %matrix transform disturbance
        Td %matrix addition disturbance
        Tuback
        Tyback
        Tvback
        Tuforward
    ...
    methods
        function obj = init(obj, x0_, backwardT, forwardT, A, B, meas_dim, control_dim)
            ...
            Tvariable D     [control_dim, control_dim];
        ...
        function obj = initAtt(obj, att0, Aatt, Batt, attcontrol_dim)
            ...
            Tvaraible attd     [attcontrol_dim, 1];
        ...
        function J = objectiveF(obj)
            ...
            J = J - obj.mheCostQ*norm2(obj.TD) - obj.mheCostQ*norm2(obj.Td) - obj.mheCostR*norm2(obj.Tvback);
        end
        ...
        function obj = setupOptimize(obj)
            ...
            P2optimizationVariablesCell = {obj.TD, obj.Td, obj.Tvback, obj.Tx0};
            ...
            outputExpressionsCell = {J,obj.Tuforward,obj.TD,obj.Td,obj.Tx0,obj.Tx, obj.Tvback};
        ...
        function obj = optimize(obj)
            ...
            %}
            [control_dim, n] = size(obj.window_controlDisturbances);
            Dmatrix = obj.window_controlDisturbances(1:control_dim, 1:control_dim);
            dadd    = obj.window_controlDisturbances(1:control_dim, end);
            ...
            if obj.use_attitude
                [Jcost, mpcUs, mheDs, mheds, x0s, xs, vs, mpcAttUs, att0s, attXs, mheAttVs] = getOutputs(obj.opt);
                ...
                [Jcost, mpcUs, mheDs, mheds, x0s, xs, vs] = getOutputs(obj.opt); %get results
            end
            ...
            obj.window_controlDisturbances = [mheDs,mheds];
