...
classdef MpcMheTransform
    ...
    methods
        ...
        function xDynamics = setupDynamicConstraints(obj)
            ...
            %return
            xDynamics = (obj.Tx == obj.Ak*xk + obj.Bk*obj.Td*u);
        end
        ...
        function J = objectiveF(obj)
            ...
            J = J - 100*norm2(obj.Td) - 1*norm2(obj.Tvback);
        end
        ...
        function obj = setupWindows(obj, window_states, window_measurements, window_controls)
            ...
            obj.window_controlDisturbances = eye(control_dim, control_dim);
